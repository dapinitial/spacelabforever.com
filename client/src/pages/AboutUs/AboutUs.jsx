  ...
  return (
    <article className="centered container section">
      ...
      <p style={{ maxWidth: '50%', margin: '0 auto', lineHeight: '32px', marginBottom: 40 }}>
        Spacelab as a concept has been swirling around since forever. -Spacelabforever- was first uttered during a long overdue mixing sesh where the origins began reconnecting the dots, regaining lost time, and set out to find the others. One onion infusion, a few hold-harmless agreements, some simulvomiting over with, are we were off -- charting our course for the upper left coast.

      </p>
      <p style={{ marginBottom: 40 }}>Cue the hand signals.</p>
      <p style={{ maxWidth: '50%', margin: '0 auto', lineHeight: '32px', marginBottom: 40 }}>
        Since inception, Spacelab has undergone many revisions. Domains have changed, team mates have served and gone on, hackathons were won, Geekwire wrote some articles, big tech spotlighted us, the governments pandered for our expertise. The mission has evolved and the spirit prevailed. Authenticity never waivered.
      </p>
      <p style={{ maxWidth: '50%', margin: '0 auto', lineHeight: '32px', marginBottom: 40 }}>
